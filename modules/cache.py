...
cache_filename = os.environ.get('HIT_NOBODY_CACHE_FILE', os.path.join(data_path, "cache.json"))
cache_dir = os.environ.get('HIT_NOBODY_CACHE_DIR', os.path.join(data_path, "cache"))
caches = {}
